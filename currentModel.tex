...
location, and skill demand. These affect the baseline hazard rate $\lambda(t)$.
...
\]
where $\sigma$ is the logistic function, $U_t$ is unemployment, and $r_t$ is the interest rate.
...
We simulate thousands of career paths (e.g., 10,000 paths, 10-year horizon, 
